...
CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, CARACTER VARCHAR(10), CODIGO INTEGER NOT NULL, CREDITOS_TEORIA DOUBLE, CREDITOS_TOTAL DOUBLE NOT NULL, CURSO INTEGER, DURACION VARCHAR(1), NOMBRE VARCHAR(30) NOT NULL, OFERTADA VARCHAR(2) NOT NULL, UNIDAD_TEMPORAL VARCHAR(10), TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (REFERENCIA))
CREATE TABLE ASIGNATURAS_MATRICULA (ASIGNACIONAUTOMATICA BOOLEAN, ASIGNATURA_REFERENCIA INTEGER NOT NULL, CURSO_ACADEMICO VARCHAR(10) NOT NULL, EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, GRUPO_ID BIGINT NOT NULL, PRIMARY KEY (ASIGNATURA_REFERENCIA, CURSO_ACADEMICO, EXPEDIENTE_NUM_EXPEDIENTE))
...
CREATE TABLE ENCUESTA (FECHA_ENVIO DATE NOT NULL, ASIGNATURA_INGLES BOOLEAN, EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (FECHA_ENVIO))
...
CREATE TABLE TITULACION (CODIGO INTEGER NOT NULL, CREDITOS DOUBLE NOT NULL, NOMBRE VARCHAR(20) NOT NULL, PRIMARY KEY (CODIGO))
