...
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR TINYINT(1) default 0, INGLES VARCHAR(2) NOT NULL, PLAZAS INTEGER, TURNO_MAÑANA_TARDE VARCHAR(6) NOT NULL, VISIBLE TINYINT(1) default 0, CURSO INTEGER NOT NULL, LETRA VARCHAR(1) NOT NULL, ID1_ID BIGINT, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE MATRICULA (ESTADO VARCHAR(10) NOT NULL, FECHA_DE_MATRICULA DATE NOT NULL, NUEVO_INGRESO VARCHAR(2), NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR(6), CURSO_ACADEMICO VARCHAR(10) NOT NULL, EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTE_NUM_EXPEDIENTE))
