...
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR TINYINT(1) default 0, INGLES VARCHAR(2) NOT NULL, PLAZAS INTEGER, TURNO_MAÑANA_TARDE VARCHAR(6) NOT NULL, VISIBLE TINYINT(1) default 0, CURSO INTEGER, LETRA VARCHAR(1), ID1_ID BIGINT, TITULACION_CODIGO DOUBLE NOT NULL, PRIMARY KEY (ID));
CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, CARACTER VARCHAR(10), CODIGO INTEGER NOT NULL, CREDITOS_TEORIA FLOAT, CREDITOS_TOTAL FLOAT NOT NULL, CURSO INTEGER, DURACION INTEGER, NOMBRE VARCHAR(30) NOT NULL, OFERTADA VARCHAR(2) NOT NULL, UNIDAD_TEMPORAL VARCHAR(10) NOT NULL, TITULACION_CODIGO DOUBLE NOT NULL, PRIMARY KEY (REFERENCIA));
CREATE TABLE ASIGNATURAS_MATRICULA (ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID BIGINT NOT NULL, MATRICULA_CURSO_ACADEMICO VARCHAR(10) NOT NULL, PRIMARY KEY (ASIGNATURA_REFERENCIA, MATRICULA_CURSO_ACADEMICO));
...
CREATE TABLE ENCUESTA (FECHA_ENVIO TIME NOT NULL, EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (FECHA_ENVIO));
CREATE TABLE EXPEDIENTE (NUM_EXPEDIENTE INTEGER NOT NULL, ACTIVO TINYINT(1) default 0, CREDITOS_SUPERADOS FLOAT, NOTA_MEDIA_PROVISIONAL FLOAT, ALUMNO_ID BIGINT NOT NULL, TITULACION_CODIGO DOUBLE NOT NULL, PRIMARY KEY (NUM_EXPEDIENTE));
CREATE TABLE GRUPOS_POR_ASIGNATURA (CURSO_ACADEMICO VARCHAR(9) NOT NULL, OFERTA VARCHAR(10), ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID BIGINT NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, ASIGNATURA_REFERENCIA, GRUPO_ID));
CREATE TABLE IDIOMAS (NOMBRE VARCHAR(20) NOT NULL, ASIGNATURA_REFERENCIA INTEGER NOT NULL, PRIMARY KEY (NOMBRE));
CREATE TABLE MATRICULA (CURSO_ACADEMICO VARCHAR(10) NOT NULL, ESTADO VARCHAR(10) NOT NULL, FECHA_DE_MATRICULA DATE NOT NULL, NUEVO_INGRESO VARCHAR(2), NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR(6), EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (CURSO_ACADEMICO));
...
CREATE TABLE TITULACION (CODIGO DOUBLE NOT NULL, CREDITOS FLOAT NOT NULL, NOMBRE VARCHAR(20) NOT NULL, PRIMARY KEY (CODIGO));
CREATE TABLE CLASE (DIA DATE NOT NULL, HORA_INICIO TIME NOT NULL, HORA_FIN TIME, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID BIGINT NOT NULL, PRIMARY KEY (DIA, HORA_INICIO, GRUPO_ID));
CREATE TABLE CENTRO_TITULACION (centros_ID BIGINT NOT NULL, titulaciones_CODIGO DOUBLE NOT NULL, PRIMARY KEY (centros_ID, titulaciones_CODIGO));
CREATE TABLE GRUPOS_POR_ASIGNATURA_ENCUESTA (encuestas_FECHA_ENVIO TIME NOT NULL, CURSO_ACADEMICO VARCHAR(9) NOT NULL, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID BIGINT NOT NULL, PRIMARY KEY (encuestas_FECHA_ENVIO, CURSO_ACADEMICO, ASIGNATURA_REFERENCIA, GRUPO_ID));
