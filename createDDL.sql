...
CREATE TABLE CLASE (HORA_FIN TIME, DIA DATE NOT NULL, HORA_INICIO TIME NOT NULL, GRUPO_ID BIGINT NOT NULL, ASIGNATURA_REFERENCIA INTEGER, PRIMARY KEY (DIA, HORA_INICIO, GRUPO_ID))
