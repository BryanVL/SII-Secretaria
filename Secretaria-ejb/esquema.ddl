CREATE TABLE ALUMNO (ID BIGINT NOT NULL, APELLIDO1 VARCHAR(20) NOT NULL, APELLIDO2 VARCHAR(20), CP INTEGER, DNI VARCHAR(10) NOT NULL UNIQUE, DIRECCION VARCHAR(50), EMAIL_INSTITUCIONAL VARCHAR(40) NOT NULL, EMAIL_PERSONAL VARCHAR(40), LOCALIDAD VARCHAR(40), MOVIL INTEGER, NOMBRE VARCHAR(15) NOT NULL, PROVINCIA VARCHAR(25), TELEFONO INTEGER, USER VARCHAR(40), PRIMARY KEY (ID))
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR BOOLEAN, CURSO INTEGER NOT NULL, INGLES VARCHAR(2) NOT NULL, LETRA VARCHAR(1) NOT NULL, PLAZAS INTEGER, PLAZASDISPONIBLES INTEGER, TURNO_MAÑANA_TARDE VARCHAR(7) NOT NULL, VISIBLE BOOLEAN, ID1_ID BIGINT, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (ID))
